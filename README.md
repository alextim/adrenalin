...
Можно не заполнять. Google их игнорирует.
 ...
 <i>Желательно, что бы Поле "Заголовок" материла и Поле "Заголовок" All In One SEO Pack отличались</i>
...
Можно использовать произвольное количеста термов в `use`. Список должен быть в кавычках `"`, раделитель `,`.

Пример: вывод на экран снаряжения для использования в одновременно на "Монблане" и "Скалолазании". 
```
[at_gear_list use="montblanc, climbing"]
```

Пример: вывод на экран снаряжения для использования в одновременно для "Ски-тура" и "Катания по ледникам". 
```
