...
## Ссылки
### Внутренние ссылки
ресурсы внутри сайта: посты, страницы, изображения - относительные, а не абсолютные
...
### Внешние ссылки
Сторонние сайты и ресурсы не должны индексироваться поисковиком через наш сайт.

Необходимо к ссылке добавить аттрибуты `target="_blank" rel="noopener nofollow"`.
