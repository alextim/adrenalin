...
Шорт-код `[at_trips_list title="Наши походы в Карпаты" ids="2895,2893,2875"]` выводит три путешествия с идентификаторами поста 2895, 2893 и 2875. 

:bulb: Для того, что бы узнать ID поста надо зайти в режим редактирования путешествия: "Путешествия" -> "All Trips" -> "Изменить". 
ID поста отображается в стороке поиска браузера.
````
